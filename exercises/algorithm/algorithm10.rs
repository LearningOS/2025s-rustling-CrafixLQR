...
impl Graph for UndirectedGraph {
    ...
    fn add_edge(&mut self, edge: (&str, &str, i32)) {
        ...
        let from_node_neighbors = self.adjacency_table_mutable()
            .get_mut(from_node)
            .unwrap();
        
        let mut edge_exists = false;
        for neighbor in from_node_neighbors.iter_mut() {
        ...
        let to_node_neighbors = self.adjacency_table_mutable()
            .get_mut(to_node)
            .unwrap();
        
        let mut edge_exists = false;
        for neighbor in to_node_neighbors.iter_mut() {
